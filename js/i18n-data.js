var I18N_LANG_DATA = {
  zh: {
    ...
    bio: {
      title: '王鹤',
      subtitle1:
        '<a href="https://english.pku.edu.cn/">北京大学计算机学院</a><a href="https://cfcs.pku.edu.cn/english">前沿计算研究中心</a>助理教授 博士生导师',
      subtitle2:
        '<a href="https://www.galbot.com">北京银河通用机器人股份有限公司</a>创始人 CTO',
      subtitle3: '<a href="https://www.bza.edu.cn/">中关村学院</a>研究型导师',
      desc1:
        '我是<a href="https://english.pku.edu.cn/">北京大学</a><a href="https://cfcs.pku.edu.cn/english">前沿计算机研究中心（CFCS）</a>助理教授、博士生导师，北京大学博雅青年学者，入选国家级海外高层次人才计划。我创立并领导了<a href="https://pku-epic.github.io/">北大具身感知与交互实验室(EPIC Lab)</a>，旨在通过研发具身泛化技能及具身多模态大模型推进通用机器人的发展。',
      desc2:
    ...
    teaching: {
      ...
      label: '北京大学本科课程：',
      item1:
        '<a href="https://dean.pku.edu.cn/service/web/courseDetail.php?flag=1&zxjhbh=BZ2526204834020_18972">具身智能导论</a>，2026年春季',
      item2:
        '<a href="https://dean.pku.edu.cn/service/web/courseDetail.php?flag=1&zxjhbh=BZ2526204834920_15659">计算机视觉导论</a>，2026年春季',
    },
    professional: {
      title: '专业服务',
    ...
    swiper: {
      ...
      slide11:
        '世界首次人机网球混双对打，现场直播连续100回合对拉，零失误。在开放动态物理环境中成功实现了感知、决策与全身运动控制的高秒级实时闭环，验证了端到端大模型在复杂智能体博弈场景下的高鲁棒性与泛化能力。',
      // slide12:
  ...
  en: {
    ...
    bio: {
      title: 'Prof. He Wang',
      subtitle1:
        'Tenure-track Assistant Professor at <a href="https://english.pku.edu.cn/">Peking University</a>',
      subtitle2:
        'Founder and CTO of <a href="https://www.galbot.com">Galbot</a>',
      subtitle3:
    ...
    swiper: {
      ...
      slide11:
        'The world’s first autonomous humanoid robot tennis rally, achieving oer 100 consecutive shots with zero errors in a live broadcast. In an open and dynamic physical environment, the system demonstrated a real-time closed loop of perception, decision-making, and whole-body motion control, validating the robustness and generalization of end-to-end models in complex agent interaction scenarios.',
      slide12:
        'Galbot ET1, the world’s first humanoid robot with autonomous learning capabilities, is powered by Galbot’s proprietary AstraBrain-Agent, a native agent for the physical world. It can perceive its surroundings in real time, understand language instructions, and dynamically plan its behaviors and action sequences.',
    },
    swiperPhone: {
      slide1:
